...
A `Vector2<class_Vector2>` parameter to be used within the visual shader
graph.
...
`Vector2<class_Vector2>` **default\_value** = `Vector2(0, 0)`
...
-   `Vector2<class_Vector2>` **get\_default\_value**()
...
`default_value<class_VisualShaderNodeVec2Parameter_property_default_value>`.
